...
import { findScssVars } from './strategies/scss-vars.cjs';
import { findLessVars } from './strategies/less-vars.cjs';
import { findStylVars } from './strategies/styl-vars.cjs';
import { findCssVars } from './strategies/css-vars.cjs';
import { findColorFunctionsInText } from './strategies/functions.cjs';
import { findRgbNoFn } from './strategies/rgbWithoutFunction.cjs';
import { findHslNoFn } from './strategies/hslWithoutFunction.cjs';
import { findHexARGB, findHexRGBA } from './strategies/hex.cjs';
import { findHwb } from './strategies/hwb.cjs';
import { findWords } from './strategies/words.cjs';
import { DecorationMap } from './lib/decoration-map.cjs';
