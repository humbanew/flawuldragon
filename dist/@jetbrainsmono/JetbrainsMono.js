...
class JetbrainsMono {
    ...
    jetbrainsMono_activate(context) {
        try {
            ...
            let activateCommand = vscode.commands.registerCommand(constants_js_1.constants.commands.jetbrainsMono.release.fdActivate, () => this.jetbrainsMono_activation(context));
            let deactivateCommand = vscode.commands.registerCommand(constants_js_1.constants.commands.jetbrainsMono.release.fdDeactivate, () => this.jetbrainsMono_desactivate(context));
