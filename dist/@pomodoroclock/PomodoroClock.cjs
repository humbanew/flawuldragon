...
class PomodoroClock {
    ...
    pomodoroClock_activate(context) {
        try {
            ...
            // list of commands
            const startDisposable = vscode.commands.registerCommand(constants_cjs_1.constants.commands.pomodoroClock.release.fdPomodoroStartClock, () => {
                pomodoroManager.start();
            });
            const pauseDisposable = vscode.commands.registerCommand(constants_cjs_1.constants.commands.pomodoroClock.release.fdPomodoroPauseClock, () => {
                pomodoroManager.pause();
            });
            const continueDisposable = vscode.commands.registerCommand(constants_cjs_1.constants.commands.pomodoroClock.release.fdPomodoroContinueClock, () => {
                pomodoroManager.continue();
            });
            const restartDisposable = vscode.commands.registerCommand(constants_cjs_1.constants.commands.pomodoroClock.release.fdPomodoroRestartClock, () => {
                pomodoroManager.restart();
            });
            const resetDisposable = vscode.commands.registerCommand(constants_cjs_1.constants.commands.pomodoroClock.release.fdPomodoroResetClock, () => {
                pomodoroManager.reset();
            });
            const toggleDisposable = vscode.commands.registerCommand(constants_cjs_1.constants.commands.pomodoroClock.release.fdToggleCurrentPomodoroCountdown, () => {
