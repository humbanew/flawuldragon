...
class ErrorLens {
    ...
    errorLens_updateEverything(context) {
        ...
        ELDecorations_ac_js_1.ELDecorations.prototype.setDecorationStyle(context);
        ELDecorations_ac_js_1.ELDecorations.prototype.updateDecorationsForAllVisibleEditors();
        $state.statusBarIcons.updateText();
        ELEvents_ac_js_1.ELEvents.prototype.updateChangeDiagnosticListener();
        ELEvents_ac_js_1.ELEvents.prototype.updateChangeVisibleTextEditorsListener();
        ELEvents_ac_js_1.ELEvents.prototype.updateOnSaveListener();
        ELEvents_ac_js_1.ELEvents.prototype.updateCursorChangeListener();
        ELEvents_ac_js_1.ELEvents.prototype.updateChangedActiveTextEditorListener();
        ELEvents_ac_js_1.ELEvents.prototype.updateChangeBreakpointsListener();
        ELEvents_ac_js_1.ELEvents.prototype.updateOnVisibleRangesListener();
    }
    /**
    ...
    errorLens_disposeEverything() {
        ELEvents_ac_js_1.ELEvents.prototype.disposeAllEventListeners();
        $state.statusBarMessage?.dispose();
        $state.statusBarIcons?.dispose();
        $state.codeLens?.dispose();
        ELDecorations_ac_js_1.ELDecorations.prototype?.disposeAllDecorations();
    }
    /**
    ...
    errorLens_activate(context) {
        try {
            ...
            ELCommands_ac_js_1.ELCommands.prototype.registerAllCommands(context);
