...
class ELExtUtils {
    ...
    prepareMessage({ template, diagnostic, lineProblemCount, removeLinebreaks, replaceLinebreaksSymbol }) {
        ...
        return ELUtils_ac_js_1.ELUtils.prototype.truncateString(removeLinebreaks ? ELUtils_ac_js_1.ELUtils.prototype.replaceLinebreaks(templated, replaceLinebreaksSymbol) : templated, ErrorLens_js_1.$config.messageMaxChars);
    }
    /**
