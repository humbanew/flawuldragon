...
class ELMultilineDecoration {
    createMultilineDecorations() {
        ...
        ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineError = vscode.window.createTextEditorDecorationType({
            after: {
        ...
        ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineWarning = vscode.window.createTextEditorDecorationType({
            after: {
        ...
        ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineInfo = vscode.window.createTextEditorDecorationType({
            after: {
        ...
        ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineHint = vscode.window.createTextEditorDecorationType({
            after: {
        ...
        ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineErrorLineBackground = vscode.window.createTextEditorDecorationType({
            backgroundColor: new vscode.ThemeColor('errorLens.errorBackground'),
            isWholeLine: true,
        });
        ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineWarningLineBackground = vscode.window.createTextEditorDecorationType({
            backgroundColor: new vscode.ThemeColor('errorLens.warningBackground'),
            isWholeLine: true,
        });
        ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineInfoLineBackground = vscode.window.createTextEditorDecorationType({
            backgroundColor: new vscode.ThemeColor('errorLens.infoBackground'),
            isWholeLine: true,
        });
        ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineHintLineBackground = vscode.window.createTextEditorDecorationType({
    ...
    showMultilineDecoration(editor) {
        ...
        if (diagnosticsForUri.length === 0 || !ELExtUtils_ac_js_1.ELExtUtils.prototype.shouldShowInlineMessage()) {
        ...
        if (ErrorLens_js_1.$config.followCursor === 'closestProblemMultiline') {
            ...
            diagnostic = ELExtUtils_ac_js_1.ELExtUtils.prototype.getClosestDiagnosticInViewport(editor);
        }
        ...
        const isProblemInViewport = ELExtUtils_ac_js_1.ELExtUtils.prototype.isDiagnosticInViewport(editor, diagnostic);
        ...
        for (const textLines of groupedTextLines) {
            ...
            const minLine = textLines.slice(0).sort((tl1, tl2) => ELExtUtils_ac_js_1.ELExtUtils.prototype.getVisualLineLength(tl2, indentSize, indentStyle) - ELExtUtils_ac_js_1.ELExtUtils.prototype.getVisualLineLength(tl1, indentSize, indentStyle))[0];
            const minVisualLineLength = Math.max(ELExtUtils_ac_js_1.ELExtUtils.prototype.getVisualLineLength(minLine, indentSize, indentStyle), ErrorLens_js_1.$config.multilineMessage.alignStart);
            result.push({
        ...
        for (const textLine of whereToShowDecoration.textLines) {
            ...
            if (ErrorLens_js_1.$config.multilineMessage.useFixedPosition) {
                ...
                const fixedMarginStyle = ELDecorationsAlign_ac_js_1.ELDecorationsAlign.prototype.getStyleForAlignment({
                ...
                const normalMarginStyle = ELDecorationsAlign_ac_js_1.ELDecorationsAlign.prototype.getStyleForAlignment({
                    isMultilineDecoration: true,
        ...
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineError, errorDecorations);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineWarning, warningDecorations);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineInfo, infoDecorations);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineHint, hintDecorations);
        if (ErrorLens_js_1.$config.multilineMessage.highlightProblemLine === 'line') {
            editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineErrorLineBackground, errorLineDecorations);
            editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineWarningLineBackground, warningLineDecorations);
            editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineInfoLineBackground, infoLineDecorations);
            editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineHintLineBackground, hintLineDecorations);
        }
        else if (ErrorLens_js_1.$config.multilineMessage.highlightProblemLine === 'range') {
            if (diagnostic.severity === 0) {
                editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.errorRange, [diagnostic.range]);
            }
            else if (diagnostic.severity === 1) {
                editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.warningRange, [diagnostic.range]);
            }
            else if (diagnostic.severity === 2) {
                editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.infoRange, [diagnostic.range]);
            }
            else if (diagnostic.severity === 3) {
                editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.hintRange, [diagnostic.range]);
            }
        }
    }
    clearAllMultilineDecorations(editor) {
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineError, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineWarning, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineInfo, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineHint, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.errorRange, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.warningRange, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.infoRange, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.hintRange, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineErrorLineBackground, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineWarningLineBackground, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineInfoLineBackground, []);
        editor.setDecorations(ELDecorations_ac_js_1.ELDecorations.prototype.decorationTypes.multilineHintLineBackground, []);
    }
    /**
