...
class ELErrorLensCodeLens {
    ...
    formatDiagnostic(diagnostic) {
        return ELExtUtils_ac_js_1.ELExtUtils.prototype.prepareMessage({
    ...
    createTitle(diagnostic) {
        ...
        return ELUtils_ac_js_1.ELUtils.prototype.truncateString(formattedDiagnostic, ErrorLens_js_1.$config.codeLensLength.max)
    ...
    provideCodeLenses(document, _cancellationToken) {
        ...
        const groupedDiagnostic = ELExtUtils_ac_js_1.ELExtUtils.prototype.groupDiagnosticsByLine(vscode.languages.getDiagnostics(document.uri));
        const codeLens = [];
