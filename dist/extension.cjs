...
const AutoRCCTag_cjs_1 = require("./@autorcctag/AutoRCCTag.cjs");
...
const TodoHighlight_cjs_1 = require("./@todohighlight/TodoHighlight.cjs");
...
const autorrctag = new AutoRCCTag_cjs_1.AutoRCCTag();
/**
