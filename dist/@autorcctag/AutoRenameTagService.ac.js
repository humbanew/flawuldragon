...
const AutoSvcHtmlScanner_ac_js_1 = require("./AutoSvcHtmlScanner.ac.js");
const AutoSvcUtil_ac_js_1 = require("./AutoSvcUtil.ac.js");
class AutoRenameTagService {
    ...
    doAutoRenameTag = (text, offset, newWord, oldWord, languageId) => {
        ...
        const scanner = AutoSvcHtmlScanner_ac_js_1.ARTSvcHtmlScanner.prototype.createScannerFast({
            input: text,
            initialOffset: 0,
        ...
        if (newWord.startsWith('</')) {
            ...
            const parent = AutoSvcUtil_ac_js_1.ARTSvcUtil.prototype.getPreviousOpeningTagName(scanner, scanner.stream.position, isSelfClosingTag, isReact);
            if (!parent) {
                return undefined;
            }
            ...
            const nextClosingTag = AutoSvcUtil_ac_js_1.ARTSvcUtil.prototype.getNextClosingTagName(scanner, scanner.stream.position, isSelfClosingTag, isReact);
            if (!nextClosingTag) {
                return undefined;
            }
            ...
            const previousOpenTag = AutoSvcUtil_ac_js_1.ARTSvcUtil.prototype.getPreviousOpeningTagName(scanner, offset, isSelfClosingTag, isReact);
            if (previousOpenTag &&
