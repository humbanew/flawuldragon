...
class AutoCloseTag {
     ...
     */
    autoCloseTag_insertAutoCloseTag(event) {
     ...
     */
    autoCloseTag_CheckRightAngleBracket(contentChange) {
     ...
     */
    autoCloseTag_CheckRightAngleBracketInVSCode_1_8(contentChange) {
     ...
     */
    autoCloseTag_getNextChar(editor, position) {
     ...
     */
    autoCloseTag_getCloseTag(text, excludedTags) {
     ...
     */
    autoCloseTag_moveSelectionRight(selection, shift) {
     ...
     */
    autoCloseTag_occurrenceCount(source, find) {
    ...
    autoCloseTag_activate(context) {
        try {
            ...
            vscode.window.showErrorMessage("An error occurred while activating the Flawuldragon Auto Close Tag: " +
                error +
