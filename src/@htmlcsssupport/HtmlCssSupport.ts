...
class HtmlCssSupport {

  htmlCssSupport_activate(context: vscode.ExtensionContext) {}
  htmlCssSupport_desactivate() {}
...
const validations = vscode.languages.createDiagnosticCollection();
...
export function activate(context: vscode.ExtensionContext) {
  context.subscriptions.push(
    vscode.languages.registerCompletionItemProvider(enabledLanguages, provider, " "),
    vscode.languages.registerDefinitionProvider(enabledLanguages, provider),
    ...
    vscode.commands.registerCommand(
      "flawuldragon.vscode-html-css.validate",
    ...
    vscode.commands.registerCommand("flawuldragon.vscode-html-css.clear", () => clear())
  );
