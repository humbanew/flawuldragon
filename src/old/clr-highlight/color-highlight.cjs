'use strict';
const { workspace, window, Range } = require('vscode');
const { findScssVars } = require('./strategies/scss-vars.cjs');
const { findLessVars } = require('./strategies/less-vars.cjs');
const { findStylVars } = require('./strategies/styl-vars.cjs');
const { findCssVars } = require('./strategies/css-vars.cjs');
const { findColorFunctionsInText } = require('./strategies/functions.cjs');
const { findRgbNoFn } = require('./strategies/rgbWithoutFunction.cjs');
const { findHslNoFn } = require('./strategies/hslWithoutFunction.cjs');
const { findHexARGB, findHexRGBA } = require('./strategies/hex.cjs');
const { findHwb } = require('./strategies/hwb.cjs');
const { findWords } = require('./strategies/words.cjs');
const { DecorationMap } = require('./lib/decoration-map.cjs');
