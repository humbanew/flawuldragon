...
export class JetbrainsMono {
   ...
   */
  public jetbrainsMono_activationPrompt = (context: vscode.ExtensionContext) =>
    this.jetbrainsMono_showDialog(
   ...
   */
  public jetbrainsMono_desactivate(context: vscode.ExtensionContext) {
    // context.globalState.update(context.extension.id, undefined);
    this.jetbrainsMono_updateUserSettings(
      this.jetbrainsMono_defaultSettings,
      true,
    );
    this.jetbrainsMono_showDialog(
