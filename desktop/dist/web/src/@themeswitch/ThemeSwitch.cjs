...
class ThemeSwitch {
    ...
    themeSwitch_Initialize() {
        ...
        this.themeSwitch_registerCommand(constants_cjs_1.constants.commands.themeSwitch.release.fdThemeSwitchDarkTheme, () => {
            if (!this.darkTheme) {
        ...
        this.themeSwitch_registerCommand(constants_cjs_1.constants.commands.themeSwitch.release.fdThemeSwitchLightTheme, () => {
            if (!this.lightTheme) {
                // TODO: dropdown to select a theme
        ...
        this.themeSwitch_registerCommand(constants_cjs_1.constants.commands.themeSwitch.release.fdThemeSwitchToggle, () => {
    ...
    themeSwitch_update(force = false) {
        ...
        if (this.switch === undefined || force) {
            this.switch?.dispose?.();
            this.switch = constants_cjs_1.constants.statusBar.positions.posB;
