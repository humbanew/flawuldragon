...
exports.ARTSvcHtmlScanner = void 0;
class ARTSvcHtmlScanner {
    /**
    ...
    createScannerFast({ input, initialOffset, initialState, matchingTagPairs }) {
        const stream = new ARTSvcHtmlScanner(input, initialOffset, matchingTagPairs);
        ...
        function scan() {
            ...
            if (stream.eos()) {
                return 13 /* EARCCTSvcHSTokenTypeFast.EOS */;
            }
            switch (state) {
                case 2 /* EARCCTSvcHSScannerStateFast.AfterOpeningEndTag */:
                    const tagName = nextElementName();
                    if (tagName) {
                        state = 4 /* EARCCTSvcHSScannerStateFast.WithinEndTag */;
                        return 9 /* EARCCTSvcHSTokenTypeFast.EndTag */;
                    }
                    else if (stream.peekRight(0) === '>') {
                        state = 4 /* EARCCTSvcHSScannerStateFast.WithinEndTag */;
                        return 9 /* EARCCTSvcHSTokenTypeFast.EndTag */;
                    }
                    return 15 /* EARCCTSvcHSTokenTypeFast.Unknown */;
                case 1 /* EARCCTSvcHSScannerStateFast.AfterOpeningStartTag */:
                    lastTagName = nextElementName();
                    if (lastTagName !== undefined) {
                        if (lastTagName === '') {
                            tokenOffset = stream.position;
                        }
                        state = 3 /* EARCCTSvcHSScannerStateFast.WithinStartTag */;
                        return 6 /* EARCCTSvcHSTokenTypeFast.StartTag */;
                    }
                    // this is a tag like "<>"
                    if (stream.peekRight() === '>') {
                        state = 3 /* EARCCTSvcHSScannerStateFast.WithinStartTag */;
                    ...
                    state = 0 /* EARCCTSvcHSScannerStateFast.WithinContent */;
                    return scan();
                default:
                    break;
            }
...
exports.ARTSvcHtmlScanner = ARTSvcHtmlScanner;
