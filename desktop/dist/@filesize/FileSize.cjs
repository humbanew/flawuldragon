...
class FileSize {
     ...
     */
    filesizeStatusBar = constants_cjs_1.constants.statusBar.positions.posE;
    /**
    ...
    filesize_getCurrentFileSize(statusItem) {
        new Promise((resolve) => {
            ...
            if (filepath == "" || filepath == "C:/Users/humba/AppData/Local/Programs/Microsoft VS Code/**/*") {
    ...
    filesize_activate(content) {
        try {
            ...
            content.subscriptions.push(vscode.commands.registerCommand(constants_cjs_1.constants.commands.filesize.release.fdFilesizeInfo, () => {
                this.filesize_getCurrentFileSize(this.filesizeStatusBar);
            }));
            let statusBarCommand = constants_cjs_1.constants.commands.filesize.release.fdFilesize;
