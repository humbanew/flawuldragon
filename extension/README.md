...
<video width="1200" controls>
  <source src="https://src.humbanew.com.br/readme-docs/flawuldragon/hn-flawuldragon-extension-demo.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

#### Status Bar Hub

<img src="https://src.humbanew.com.br/readme-docs/flawuldragon/flawuldragon-status-bar-hub-features-v2.png" alt="Flawuldragon Status Bar Hub" />
...
### Keybindings
  ...
  | `alt + d` | `cmd + alt + d` | Vanilla | Interruptor Vanilla DateTime Status Bar |
  | `alt + d` `a` | `cmd + alt + d` `a` | Vanilla | Set American Date Format |
  | `alt + d` `1` | `cmd + alt + d` `1` | Vanilla | Set 12h Time Format |
  | `alt + d` `i` | `cmd + alt + d` `i` | Vanilla | Invert Date and Time Properties |
  | `alt + d` `v` | `cmd + alt + d` `v` | Vanilla | Switch Visibility Date or Time |
  | `alt + d` `s` | `cmd + alt + d` `s` | Vanilla | Show Seconds |
  | `alt + d` `w` | `cmd + alt + d` `w` | Vanilla | Show Day of Week |
  | `alt + i` | `cmd + alt + i` | Vanilla | Enable Inlay Hints |
  | `alt + i` `f` | `cmd + alt + i` `f` | Vanilla | Set Inlay Hints Font Family |
  | `alt + i` `s` | `cmd + alt + i` `s` | Vanilla | Set Inlay Hints Font Size |
  ...
  | `alt + e` `e` | `cmd + alt + e` `e` | ErrorLens | Enable or disable ErrorLens Errors |
  | `alt + e` `w` | `cmd + alt + e` `w` | ErrorLens | Enable or disable ErrorLens Warnings |
  | `alt + e` `i` | `cmd + alt + e` `i` | ErrorLens | Enable or disable ErrorLens Infos |
  | `alt + e` `h` | `cmd + alt + e` `h` | ErrorLens | Enable or disable ErrorLens Hints |
  | `alt + e` `m` | `cmd + alt + e` `m` | ErrorLens | Enable or disable ErrorLens Inline Messages |
  | `alt + e` `s` | `cmd + alt + e` `s` | ErrorLens | Search for Problem |
  | `alt + e` `p` | `cmd + alt + e` `p` | ErrorLens | Select Problem |
  | `alt + e` `w` | `cmd + alt + e` `w` | ErrorLens | Toggle Workspace in Disabled List |
  | `alt + e` `d` | `cmd + alt + e` `d` | ErrorLens | Disable Line |
  | `alt + e` `r` | `cmd + alt + e` `r` | ErrorLens | Find Linter Rule Definition |
  | `alt + e` `c` | `cmd + alt + e` `c` | ErrorLens | Copy Problem Message |
  ...
  | `alt + p` `r` | `cmd + alt + p` `r` | Pomodoro | Restart Pomodoro |
  | `alt + p` `x` | `cmd + alt + p` `x` | Pomodoro | Reset Pomodoro |
  | `alt + p` `t` | `cmd + alt + p` `t` | Pomodoro | Toggle Current Pomodoro Countdown |
  | `alt + p` `b` | `cmd + alt + p` `b` | Pomodoro | Show or Hide the Pomodoro Clock status bar item |
  | `alt + p` `s` | `cmd + alt + p` `s` | Pomodoro | Show or Hide the Pomodoro Type status bar item |
  | `alt + b` | `cmd + alt + b` | Pomodoro | Take a break: Start |
  | `alt + b` `s` | `cmd + alt + b` `s` | Pomodoro | Take a break: Stop |
  | `alt + t` `l` | `cmd + alt + t` `l` | Theme Switcher | Switch to Light Theme |
  | `alt + t` `d` | `cmd + alt + t` `d` | Theme Switcher | Switch to Dark Theme |
  | `alt + t` `t` | `cmd + alt + t` `t` | Theme Switcher | Enable/Disable Theme Switch |
  | `alt + h` | `cmd + alt + h` | Todo Highlight | Toggle Highlight |
  | `alt + h` `l` | `cmd + alt + h` `l` | Todo Highlight | List highlighted annotations |
  | `alt + h` `b` | `cmd + alt + h` `b` | Todo Highlight | Show or Hide the todo highlight status bar item |
...
>
> ![Usage](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/auto-close-tag/usage.gif)
>
> To add close tag manually, use shortcut `Alt+.` (`Command+Alt+.` for Mac), or press `F1` and then select/type `Close Tag`
> 
> ![Usage](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/auto-close-tag/close-tag.gif)
> 
> ## Sublime Text 3 Mode
> 
...
> 
> ![Sublime Text 3](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/auto-close-tag/st3.gif)
>
> ## Configuration
> 
...
> ## Usages
>
> ![Usage](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/auto-rename-tag/usage.gif)
>
> ## Configuration
>
> Add entry into `fd.auto-rename-tag.activationOnLanguage` to set the languages that the extension will be activated.
...
> This tweaked version of Carbon Icons focuses on the <b>symbol icons</b> and the overall <b>icon consistency</b>.
>
...
> ## Features
>
> <img src="https://src.humbanew.com.br/readme-docs/flawuldragon/integration/charmed-icons/files.png" alt="Files" width="512" />
> <br><br>
> <img src="https://src.humbanew.com.br/readme-docs/flawuldragon/integration/charmed-icons/folders.png" alt="Folders" width="512" />
>
...
> 
> #### *Some of the above resources have been removed or disabled by the need for the appeal.*
>
> ## Colors (30)
>
...
>
> ![ErrorLens example](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/errorlens-alt/Screenshot-1.png)
>
> ## Features
>
...
>
> ![Fluent icon preview](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/fluent-icons/preview.png)
...
>
> ![Preview v2](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-icons/preview2023.png)
>
> ### V1
>
> ![Preview v1](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-icons/preview.png)
...
>
> ![Alt text](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-mono/main-img%402x.png)
>
> # How to install
>
> #### Install font:
>
> <img src="assets/documentation/integration/jetbrains-mono/JBM-font-directory.gif" width="400" />
>
...
>
> ![Alt text](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-mono/font-styles@2x.png)
>
> ## Font Features
>
> ### Increased x-height
...
>
> ![Alt text](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-mono/ff-increased-height@2x.png)
>
> ### Distinctiveness of symbols
>
> ![Alt text](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-mono/ff-distinctiveness-of-symbols@2x.gif)
>
> ## Ligatures for Code
>
...
>
> ![Alt text](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-mono/ligatures-1@2x.gif)
>
> 2. To balance whitespace more efficiently by shifting the glyphs in certain cases:
>
> ![Alt text](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-mono/ligatures-2@2x.gif)
>
> ## Basic Character Set
>
> ![Alt text](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/jetbrains-mono/character-set@2x.png)
>
...
>      <img src="./assets/documentation/integration/pomodoro-clock/pomodoro-clock.png" alt="Logo"/>
>    </a>
>  </div>
>
...
>
> ![Demo](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/pomodoro-clock/demo.gif)
>
>> Notification when time up
>
> ![Demo](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/pomodoro-clock/time-up.jpg)
>
>> Pomodoro clock Extension Settings
>
> ![Demo](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/pomodoro-clock/vscode-config.jpg)
>
> ## Extension Settings
> This extension contributes the following settings:
>
...
>
> ![Extension preview](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/sakai-icons/preview.png)
>
> Pick your favorite theme and have fun! 🎉
> ![Options of icons](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/sakai-icons/icon_theme.png)
>
> ### Icon Previews
>
...
> | fd.todohighlight.defaultStyle | object | N/A | Specify the default style for custom keywords, if not specified, build in default style will be applied. [See all available properties on VSCode doc DecorationRenderOptions section](https://code.visualstudio.com/api/references/vscode-api#DecorationRenderOptions) |
> | fd.todohighlight.include | array | [<br>`"**/*.js"`,<br>`"**/*.jsx"`,<br>`"**/*.ts"`,<br>`"**/*.tsx",`<br>`"**/*.html"`,<br>`"**/*.php"`,<br>`"**/*.css",`<br>`"**/*.scss"`<br>] | Glob patterns that defines the files to search for. Only include files you need, DO NOT USE `{**/*.*}` for both permormance and avoiding binary files reason. <br> For backwards compatability, a string combine all the patterns is also valid `"{**/*.js,**/*.jsx,**/*.ts,**/*.tsx,**/*.html,**/*.php,**/*.css,**/*.scss}"` |
> | fd.todohighlight.exclude | array | [<br>`"**/node_modules/**"`,<br>`"**/dist/**",`<br>`"**/bower_components/**"`,<br>`"**/build/**",`<br>`"**/.vscode/**"`,<br>`"**/.github/**"`,<br>`"**/_output/**"`,<br>`"**/*.min.*"`,<br>`"**/*.map"`<br>] | Glob pattern that defines files and folders to exclude while listing annotations. <br> For backwards compatability, a string combine all the patterns is also valid `"{**/node_modules/**,**/bower_components/**,**/dist/**,**/build/**,**/.vscode/**,**/_output/**,**/*.min.*,**/*.map}"` |
...
> ## Icon Preview
>
> ![Preview Dark](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/vsc-nomo-icons/previewdark.png)
> ![Preview Dark MacOS](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/vsc-nomo-icons/previewdarkmacos.png)
> ![Preview Light](https://src.humbanew.com.br/readme-docs/flawuldragon/integration/vsc-nomo-icons/previewlight.png)
...
All license terms and use notifications are available in the `LICENSE.md` file at the root of the project.
[Page of LICENSE.md](https://raw.githubusercontent.com/humbanew/flawuldragon/refs/heads/main/LICENSE.md)

## Support and communication channels

[Humbanew Support Mail](mailto:support@humbanew.com.br)
[Humbanew Flawuldragon Discussions](https://github.com/humbanew/flawuldragon/discussions)
[Humbanew Flawuldragon Pull Requests](https://github.com/humbanew/flawuldragon/pulls)
...
<a href="https://www.buymeacoffee.com/humba01"><img src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=humba01&button_colour=8838ff&font_colour=ffffff&font_family=Lato&outline_colour=ffffff&coffee_colour=FFDD00" /></a>

<form action="https://www.paypal.com/donate" method="post" target="_top">
<input type="hidden" name="business" value="FDLTHLZ92JM9Q" />
...
<img src="https://src.humbanew.com.br/readme-docs/flawuldragon/flawuldragon-archtecture-demonstration.png" alt="Flawuldragon Arch Demo" />
</div>
...
<div align="center">
  ...
  ## Humbanew Project @ 2015-2026. All rights reserved.
